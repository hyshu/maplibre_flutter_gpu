...
typedef InitD =
    int Function(int width, int height, double pixelRatio, Pointer<Utf8> url);
...
typedef SetRenderRequestCallbackN =
    Void Function(Pointer<NativeFunction<RenderRequestN>> callback);
typedef SetRenderRequestCallbackD =
    void Function(Pointer<NativeFunction<RenderRequestN>> callback);
...
typedef SetContentInsetsWithDurationN =
    Int32 Function(
      Double top,
      Double left,
      Double bottom,
...
typedef SetContentInsetsWithDurationD =
    int Function(
      double top,
      double left,
      double bottom,
...
typedef StyleAddLayerN =
    Int32 Function(Pointer<Utf8> layerJson, Pointer<Utf8> beforeLayerId);
typedef StyleAddLayerD =
    int Function(Pointer<Utf8> layerJson, Pointer<Utf8> beforeLayerId);
typedef StyleLayerJsonN =
    Int32 Function(Pointer<Utf8> layerId, Pointer<Utf8> propertiesJson);
typedef StyleLayerJsonD =
    int Function(Pointer<Utf8> layerId, Pointer<Utf8> propertiesJson);
typedef StyleLayerIdN = Int32 Function(Pointer<Utf8> layerId);
typedef StyleLayerIdD = int Function(Pointer<Utf8> layerId);

typedef LatLonToScreenN =
    Void Function(
      Double lat,
      Double lon,
      Pointer<Double> outX,
